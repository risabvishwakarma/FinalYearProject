...
//        actionBar.hide();
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions
                ...
                .requestIdToken("193967316597-1okbciap7ijovbcc6r8sjp0dof2sibsl.apps.googleusercontent.com")
                .requestEmail()
                .build();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            assert user != null;
                            Toast.makeText(SignIn.this, user.getDisplayName(), Toast.LENGTH_SHORT).show();
                            updateUI(user);
                        } else {
